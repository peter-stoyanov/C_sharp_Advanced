    ...
    class SecondNature //30/100 - runtime error
    {
        static void Main(string[] args)
        {
            ...
            while (flowersQueue.Count > 0 && bucketStack.Count > 0)
            {
                ...
                ////If the current bucket’s value is equal to the current flower’s current value
            ...
            string secondNatire = flowersSecondNatureQueue.Count > 0 
                ? string.Join(" ", flowersSecondNatureQueue) 
                : "None";
