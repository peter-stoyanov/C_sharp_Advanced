...
namespace _04
{
    class _04HospitalQueue
    {
        ...
        {
            var departments = new Dictionary<string, Queue<Patient>>();
            ...
            while ((input = Console.ReadLine()) != "Output")
            {
                ...
                {
                    departments[departmentName].Enqueue(newPatient);

                }
                else
                {
                    var queue = new Queue<Patient>();
                    queue.Enqueue(newPatient);
                    departments.Add(departmentName, queue);
                }
            }
